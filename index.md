...
<small><strong>Disclosure.</strong> <em>The author has previously consulted at Together AI, one of the neo-clouds mentioned by name in this piece, and has helped start an American neo-lab. The arguments above are about a market in which the author has had a direct financial and professional stake. Readers should weigh that accordingly.</em></small>
